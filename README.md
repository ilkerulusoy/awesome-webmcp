...
- [Join the WebMCP origin trial – Chrome for Developers](https://developer.chrome.com/blog/ai-webmcp-origin-trial) — Official Chrome blog post announcing the public origin trial in Chrome 149 (announced at Google I/O 2026), covering sign-up steps and what developers can test during the trial window (Chrome 149–156).
- [WebMCP | AI on Chrome – Chrome for Developers](https://developer.chrome.com/docs/ai/webmcp) — Official Chrome AI docs reference for the WebMCP API: declarative HTML attributes, imperative `navigator.modelContext` calls, origin trial registration, and DevTools debugging guidance.
- [15 updates from Google I/O 2026: Powering the agentic web – Chrome for Developers](https://developer.chrome.com/blog/chrome-at-io26) — Google I/O 2026 Chrome roundup that formally introduced the WebMCP origin trial and announced Gemini in Chrome will soon support WebMCP APIs.
...
- [WebMCP Standard Proposal for Agentic Web Actuation Now Available in Chrome (Origin Trials) – InfoQ](https://www.infoq.com/news/2026/06/webmcp-web-agent-standard-chrome/) — June 2026 InfoQ news article covering the Chrome 149 origin trial launch, the spec's W3C status, and early reactions from the developer community.
- [WebMCP Is the Most Important Thing Google Announced at I/O 2026 – DEV Community](https://dev.to/tejas1643/webmcp-is-the-most-important-thing-google-announced-at-io-2026-and-almost-nobody-is-talking-about-1j8m) — Developer perspective arguing WebMCP is underreported among the I/O 2026 announcements and explaining why structured tool exposure matters more than flashier AI features.
- [What Is WebMCP? The Google I/O 2026 Web Standard That Changes AI Agent Tool Use – DEV Community](https://dev.to/soumyadeepdey/why-webmcp-is-the-most-important-thing-google-announced-at-io-2026-and-nobodys-talking-about-it-2edf) — In-depth breakdown of WebMCP as the standout Google I/O 2026 announcement for web developers, with code examples and a comparison to DOM-scraping approaches.
- [Chrome 149 origin trial puts WebMCP in developers' hands at last – PPC.land](https://ppc.land/chrome-149-origin-trial-puts-webmcp-in-developers-hands-at-last/) — PPC-industry analysis of the Chrome 149 origin trial: how structured tool calls replace fragile screenshot-based automation and what it means for paid-search marketers building agentic flows.
- [Google Details WebMCP Origin Trial for Chrome 149 With DevTools Support – The Drop Times](https://www.thedroptimes.com/70389/google-webmcp-chrome-149-origin-trial) — News report covering the Chrome 149 origin trial details, the new DevTools debugging panel, and the trial window running through Chrome 156.
...
- [Chrome for Developers – "The WebMCP API will enter origin trial starting in Chrome 149"](https://x.com/ChromiumDev/status/2056847918926045478) — Official announcement of the Chrome 149 origin trial with a link to the sign-up page; explains how structured tools let agents know "exactly how and where to interact" with a page.
- [Chrome for Developers – Chrome 149 DevTools + WebMCP debugging](https://x.com/ChromiumDev/status/2064076036472557730) — Thread highlighting the new WebMCP debugging panel added to Chrome 149 DevTools Application tab.
- [André Bandarra – "WebMCP will enter the Origin Trial in Chrome 149"](https://x.com/andreban/status/2056859717176103261) — Chrome engineer post pointing developers to the official docs and encouraging them to try the flag preview ahead of the origin trial.
...
- [Intent to Experiment: WebMCP – Blink Dev](https://groups.google.com/a/chromium.org/g/blink-dev/c/gmYffo5WOE8/m/OJxuQRP3AAAJ) — Official Chromium mailing list thread where the Chrome team formally requested permission to run the WebMCP origin trial; includes API scope, risk assessment, and links to the spec.
